...
from .pagination import iterate_audit_events, iterate_audit_pages, iterate_search_pages, iterate_search_results
from .retry import RetryConfig, backoff_sleep, should_retry_exception, should_retry_response
from .tasks import wait_for_task_completion
...
class MGPClient:
    ...
    def write_memory(
        ...
        return self._post("/mgp/write", policy_context, {"memory": memory}, request_id=request_id)
    ...
    def write_candidate(
        ...
        *,
        ...
        return self._post("/mgp/write", policy_context, payload, request_id=request_id)
    ...
    def search_memory(
        ...
        return self._post("/mgp/search", policy_context, payload, request_id=request_id)
    ...
    def get_memory(
        ...
        return self._post("/mgp/get", policy_context, {"memory_id": memory_id}, request_id=request_id)
    ...
    def expire_memory(
        ...
        *,
        ...
        return self._post("/mgp/expire", policy_context, payload, request_id=request_id)
    ...
    def revoke_memory(
        ...
        *,
        ...
        if reason is not None:
            payload["reason"] = reason
        return self._post("/mgp/revoke", policy_context, payload, request_id=request_id)
    ...
    def delete_memory(
        ...
        *,
        ...
        if reason is not None:
            payload["reason"] = reason
        return self._post("/mgp/delete", policy_context, payload, request_id=request_id)
    ...
    def purge_memory(
        ...
        *,
        ...
        if reason is not None:
            payload["reason"] = reason
        return self._post("/mgp/purge", policy_context, payload, request_id=request_id)
    ...
    def write_batch(
        ...
        *,
        ...
        return self._post("/mgp/write/batch", policy_context, {"items": items}, request_id=request_id)
    ...
    def export_memories(
        ...
        *,
        ...
        return self._post("/mgp/export", policy_context, payload, request_id=request_id)
    ...
    def import_memories(
        ...
        *,
        ...
        return self._post("/mgp/import", policy_context, payload, request_id=request_id)
    ...
    def sync_memories(
        ...
        *,
        ...
        return self._post("/mgp/sync", policy_context, payload, request_id=request_id)

    def get_capabilities(self) -> CapabilitiesResponseData:
        response_body = self._request_json("GET", "/mgp/capabilities")
    ...
    def initialize(
        ...
        *,
        ...
        response_body = self._request_json("POST", "/mgp/initialize", json_body=payload)
    ...
    def query_audit(
        ...
        return self._post("/mgp/audit/query", policy_context, payload, request_id=request_id)

    def get_task(self, task_id: str, request_id: str | None = None) -> AsyncTask:
    ...
    def cancel_task(self, task_id: str, *, reason: str | None = None, request_id: str | None = None) -> AsyncTask:
        payload: dict[str, Any] = {
            "request_id": _request_id(request_id),
            "task_id": task_id,
        }
        if reason is not None:
            payload["reason"] = reason
        response_body = self._request_json("POST", "/mgp/tasks/cancel", json_body=payload)
        return response_body["data"]["task"]
    ...
    def iter_search_pages(
        ...
        return iterate_search_pages(self, policy_context, search)
    ...
    def iter_search_results(
        ...
        return iterate_search_results(self, policy_context, search)
    ...
    def iter_audit_pages(
        ...
        return iterate_audit_pages(self, policy_context, query)
    ...
    def iter_audit_events(
        ...
        return iterate_audit_events(self, policy_context, query)
    ...
    def _post(
        ...
        *,
        ...
        response_body = self._request_json("POST", path, json_body=body)
        return MGPResponse(
        ...
        while True:
            ...
            try:
                ...
                if should_retry_exception(error, self.options.retry, attempt):
                    backoff_sleep(self.options.retry, attempt)
                    continue
                raise BackendError(
